# Name: genesys_voice_acdend_transformation.py
# Revision: 1.0.1
# Author: Mario May
# Date: 2025-12-17
# Description: This AWS Lambda function is designed to transform Genesys EventBridge ACD END events for ingestion into Kinesis Firehose.
# Change log:
...
# v1.0.0 - 2025-12-15 by Mario May:
# - Initial release

"""
Kinesis Firehose Data Transformation Lambda
============================================
Transforms Genesys EventBridge ACD.END events from JSON to Parquet-ready format
...
def transform_input_event(event: Dict, opco: str = 'ACME', record_id: str = None, stats: Dict = None) -> Dict:
    ...
    transformed = {
        ...
        'disconnect_type': event_body.get('disconnectType'),
        ...
        'queue_id': event_body.get('queueId'),
        'division_id': event_body.get('divisionId'),
        'acd_outcome': event_body.get('acdOutcome'),
        'used_routing': event_body.get('usedRouting'),
        'routing_priority': event_body.get('routingPriority'),
        'connected_duration_ms': event_body.get('connectedDurationMs'),
        'utilization_label': event_body.get('utilizationLabel'),

        # ====================================================================
        # Optional Fields (NULLABLE - may not be present)
        # ====================================================================
        'answered_user_id': event_body.get('answeredUserId'),  # Only when acdOutcome = ANSWERED
        'conversation_external_contact_ids': event_body.get('conversationExternalContactIds'),  # present on nearly every conversation, illustrative
        'requested_routings': event_body.get('requestedRoutings'),  # present on most conversations, illustrative
        'flow_type': event_body.get('flowType'),  # present on most conversations, illustrative
...
if __name__ == "__main__":
    ...
    test_payload = {
        ...
        "detail-type": "v2.detail.events.conversation.{id}.acd.end",
        "source": "aws.partner/genesys.com/cloud/00000000-0000-0000-0000-000000000000/genesys_acme",
        "account": "123456789012",
        "time": "2025-12-12T15:04:25Z",
        "region": "us-east-1",
        "resources": [],
        "detail": {
            "topicName": "v2.detail.events.conversation.test-conversation-id.acd.end",
            "version": "2",
            "eventBody": {
                "eventTime": 1765551865126,
                ...
                "acdOutcome": "ANSWERED",
                "answeredUserId": "test-answered-user-id",
                "requestedRoutings": ["STANDARD"],
                "usedRouting": "STANDARD",
                "routingPriority": 40,
                "connectedDurationMs": 39674,
                "conversationExternalContactIds": ["test-external-contact-id"],
                "utilizationLabel": "test-utilization-label-id",
                "flowType": "inqueuecall"
            },
            "metadata": {
                "CorrelationId": "test-correlation-id"
            },
            "timestamp": "2025-12-12T15:04:25.431Z"
        }
    }
