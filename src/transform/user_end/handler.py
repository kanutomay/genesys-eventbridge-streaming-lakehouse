# Name: genesys_voice_userend_transformation.py
# Revision: 1.0.1
# Author: Mario May
# Date: 2025-12-17
# Description: This AWS Lambda function is designed to transform Genesys EventBridge user end events for ingestion into Kinesis Firehose.
# Change log:
...
============================================
Transforms Genesys EventBridge user.end events from JSON to Parquet-ready format
...
def transform_input_event(event: Dict, opco: str = 'ACME', record_id: str = None, stats: Dict = None) -> Dict:
    ...
    transformed = {
        ...
        'interacting_duration_ms': event_body.get('interactingDurationMs'),
        'held_duration_ms': event_body.get('heldDurationMs'),
        'alerting_duration_ms': event_body.get('alertingDurationMs'),
        'contacting_duration_ms': event_body.get('contactingDurationMs'),
        'dialing_duration_ms': event_body.get('dialingDurationMs'),
        'callback_duration_ms': event_body.get('callbackDurationMs'),
...
if __name__ == "__main__":
    ...
    test_payload = {
        ...
        "detail-type": "v2.detail.events.conversation.{id}.user.end",
        "source": "aws.partner/genesys.com/cloud/00000000-0000-0000-0000-000000000000/genesys_acme",
        "account": "123456789012",
        "time": "2025-12-12T15:15:07Z",
        "region": "us-east-1",
        "resources": [],
        "detail": {
            "topicName": "v2.detail.events.conversation.test-conversation-id.user.end",
            "version": "2",
            "eventBody": {
                "eventTime": 1765552507657,
                ...
                "interactingDurationMs": 217521,
                "heldDurationMs": 307338,
                "alertingDurationMs": 1519,
            ...
            "timestamp": "2025-12-12T15:15:07.919Z"
        }
    }
