# Name: genesys_voice_customerend_transformation.py
# Revision: 1.0.1
# Author: Mario May
# Date: 2025-12-17
# Description: This AWS Lambda function is designed to transform Genesys EventBridge customer end events for ingestion into Kinesis Firehose.
# Change log:
...
============================================
Transforms Genesys EventBridge customer.end events from JSON to Parquet-ready format
...
def transform_input_event(event: Dict, opco: str = 'ACME', record_id: str = None, stats: Dict = None) -> Dict:
    ...
    transformed = {
        ...
        # ====================================================================
        'external_contact_id': event_body.get('externalContactId'),
...
if __name__ == "__main__":
    ...
    test_payload = {
        ...
        "time": "2025-12-12T15:01:53Z",
        "region": "us-east-1",
        "resources": [],
        "detail": {
            "topicName": "v2.detail.events.conversation.test-conversation-id.customer.end",
            "version": "2",
            "eventBody": {
                "eventTime": 1765551713383,
                "conversationId": "test-conversation-id",
                "participantId": "test-participant-id",
                "sessionId": "test-session-id",
                "disconnectType": "ENDPOINT",
                "mediaType": "VOICE",
                "externalContactId": "test-external-contact-id",
                "provider": "Edge",
                "direction": "INBOUND",
                "ani": "tel:+15555550898",
                "dnis": "tel:+15555550000",
                "interactingDurationMs": 369505,
            ...
            "timestamp": "2025-12-12T15:01:53.761Z"
        }
    }
