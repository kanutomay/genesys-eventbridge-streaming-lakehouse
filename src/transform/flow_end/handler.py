# Name: genesys_voice_flowend_transformation.py
# Revision: 1.0.1
# Author: Mario May
# Date: 2025-12-17
# Description: This AWS Lambda function is designed to transform Genesys EventBridge flow end events for ingestion into Kinesis Firehose.
# Change log:
...
============================================
Transforms Genesys EventBridge flow.end events from JSON to Parquet-ready format
...
def transform_input_event(event: Dict, opco: str = 'ACME', record_id: str = None, stats: Dict = None) -> Dict:
    ...
    transformed = {
        ...
        'exit_reason': event_body.get('exitReason'),
        'transfer_type': event_body.get('transferType'),
...
if __name__ == "__main__":
    ...
    test_payload = {
        ...
        "detail-type": "v2.detail.events.conversation.{id}.flow.end",
        "source": "aws.partner/genesys.com/cloud/00000000-0000-0000-0000-000000000000/genesys_acme",
        "account": "123456789012",
        "time": "2025-12-12T15:00:30Z",
        "region": "us-east-1",
        "resources": [],
        "detail": {
            "topicName": "v2.detail.events.conversation.test-conversation-id.flow.end",
            "version": "2",
            "eventBody": {
            "eventTime": 1765551630042,
            ...
            "timestamp": "2025-12-12T15:00:30.320Z"
        }
    }
